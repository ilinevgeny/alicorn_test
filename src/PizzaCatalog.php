...
//
//$pizza = $catalog->getPizza('MacDac Pizza');
//echo $pizza->getPrice() . PHP_EOL;
//
//$pizza->addIngredient($ingredientCatalog->getIngredient('sliced mushrooms'));
//
//echo $pizza->getPrice() . PHP_EOL;
//$pizza->removeIngredient('tomato');
//$pizza->removeIngredient('feta cheese');
//$pizza->ingredientOnTop('sliced mushrooms');
//
//$pizza->ingredientOnTop('tomato');
//$pizza->ingredientOnTop('sausages');
//
//echo $pizza->getIngredientOrder() . PHP_EOL;
//$pizza->ingredientOnTop('sliced mushrooms');
//$pizza->addIngredient($ingredientCatalog->getIngredient('sliced mushrooms'));
//echo $pizza->getIngredientOrder() . PHP_EOL;
//$pizza->addIngredient($ingredientCatalog->getIngredient('mozzarella cheese'));
//$pizza->ingredientOnTop('mozzarella cheese');
//echo $pizza->getIngredientOrder() . PHP_EOL;
//echo $pizza->getPrice();
